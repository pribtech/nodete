...
-->
<xsl:param name="action">status</xsl:param>
...
systemctl <xsl:value-of select="$action"/>  <xsl:value-of select="data[@name='service']/text()"/> <xsl:value-of select="key[@name='service']/text()"/>   
