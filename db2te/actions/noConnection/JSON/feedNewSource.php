...
$returnInformation['returnValue'] = 'Can not create new source';


$returnInformation['returnValue'] = feedSourceManager::updateSourceList();

if($returnInformation['returnValue'] === true)
{
	$returnInformation['returnCode'] = 'true';
	$returnInformation['returnValue'] = 'Successfully added';
}
