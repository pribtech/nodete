 ...
 *********************************************************************************/
function openModalDialog(data, type, callingActionStack, parameters) {
	if(type == null)
		type = "RAW";
	new modalPanelDialog("alertModalPanel_" + getGUID(), type, data, false, callingActionStack, parameters);
}
var modalPanelDialog = Class.create(modalPanel, {
	...
	modalPanelControls: function () {
        ...
        output += " selected onClick=\"activeModalPanel.get('" + this.elementUniqueID + "').returnCall('true');\">" + CORE_MESSAGE_STORE.LANGUAGE_MESSAGES.OK + "</button>";
		return output;
	}
});